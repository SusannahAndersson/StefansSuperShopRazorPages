...
namespace StefansSuperShop.Migrations
{
    ...
    [Migration("20221221164447_mssql.azure_migration_351")]
    partial class mssqlazure_migration_351
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsletterNewsletterSubscriber", b =>
                {
                    b.Property<int>("NewslettersNewsletterId")
                        .HasColumnType("int");

                    b.Property<int>("SubscribersNewsletterSubscriberId")
                        .HasColumnType("int");

                    b.HasKey("NewslettersNewsletterId", "SubscribersNewsletterSubscriberId");

                    b.HasIndex("SubscribersNewsletterSubscriberId");
            ...
            modelBuilder.Entity("StefansSuperShop.Data.NewsletterSubscriber", b =>
                {
                    b.Property<int>("NewsletterSubscriberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("NewsletterSubscriberID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NewsletterSubscriberId"), 1L, 1);
            ...
            modelBuilder.Entity("NewsletterNewsletterSubscriber", b =>
                {
                    b.HasOne("StefansSuperShop.Data.Newsletter", null)
                        .WithMany()
                        .HasForeignKey("NewslettersNewsletterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StefansSuperShop.Data.NewsletterSubscriber", null)
                        .WithMany()
                        .HasForeignKey("SubscribersNewsletterSubscriberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
